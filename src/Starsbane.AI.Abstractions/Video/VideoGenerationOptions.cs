...
namespace Starsbane.AI
{
    public class VideoGenerationOptions
    {
        ...
        protected VideoGenerationOptions(VideoGenerationOptions? other)
        {
            ...
            VideoDimensions = other.VideoDimensions;
        ...
        /// </remarks>
        public Size? VideoDimensions { get; set; }
        ...
        /// When <see cref="IVideoGenerator.GenerateAsync" /> is invoked with an <see cref="VideoGenerationOptions" />,
