...
namespace Starsbane.AI
{
    public class TextExtractionOptions
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="TextExtractionOptions"/> class.</summary>
        public TextExtractionOptions()
        {
        }

        /// <summary>Initializes a new instance of the <see cref="TextExtractionOptions"/> class, performing a shallow copy of all properties from <paramref name="other"/>.</summary>
        protected TextExtractionOptions(TextExtractionOptions? other)
        {
            if (other is null)
            {
                return;
        ...
        /// <summary>Produces a clone of the current <see cref="TextExtractionOptions"/> instance.</summary>
        /// <returns>A clone of the current <see cref="TextExtractionOptions"/> instance.</returns>
        public virtual TextExtractionOptions Clone() => new(this);
    }
}
